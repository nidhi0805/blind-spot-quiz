...
const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-16 bg-fia-background relative">
      <div className="fia-container relative z-10">
        <div className="text-center mb-20 animate-fade-in">
          <h1 className="text-4xl sm:text-5xl font-semibold text-fia-text mb-6 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl border border-fia-border shadow-md hover:shadow-xl transition-all animate-slide-up transform hover:-translate-y-1">
            ...
            <h3 className="font-semibold text-xl mb-4">Discover Your Patterns</h3>
          ...
          <div className="bg-white p-8 rounded-xl border border-fia-border shadow-md hover:shadow-xl transition-all animate-slide-up transform hover:-translate-y-1">
            ...
            <h3 className="font-semibold text-xl mb-4">Recognize Warning Signs</h3>
            <p className="text-fia-textLight leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-xl border border-fia-border shadow-md hover:shadow-xl transition-all animate-slide-up transform hover:-translate-y-1">
            ...
            <h3 className="font-semibold text-xl mb-4">Build Better Defenses</h3>
            <p className="text-fia-textLight leading-relaxed">
